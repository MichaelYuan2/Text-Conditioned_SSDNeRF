...
dataset_type = 'TextConditionedSSDNeRF'
data = dict(
    samples_per_gpu=8,
    workers_per_gpu=4,
    train=dict(
        ...
        cache_path='data/abo/text/tables_train_cache.pkl',
        text_encoder='openai/clip-vit-base-patch32'),
    val_uncond=dict(
        type=dataset_type,
        ...
        max_num_scenes=1000,
        cache_path='data/abo/text/tables_traintest_cache.pkl'),
...
total_iters = 1000  # K_out (outer loop iterations)
log_config = dict(
    interval=50,
    hooks=[
